            ...
            property: function ($component) {
                ...
                $('#lr_component_dataType').lrselect({
                    data: [
                        ...
                        { id: 'user', text: '当前用户ID' },                        
                        { id: 'username', text: '当前用户名' },//by wxl 当前信息添加当前用户名
                        { id: 'time', text: '当前时间' }
                    ],
                    value: 'id',
                    text: 'text',
            ...
            renderTable: function (compont, $row) {
                ...
                switch (compont.dataType) {
                    ...
                    case 'user':
                        ...
                        break;
                    //start by wxl 当前信息添加当前用户名
                    case 'username':
                        $compont.val(loginInfo.realName);
                        $compont[0].lrvalue = loginInfo.realName;
                        break;
                    //end by wxl 当前信息添加当前用户名
                    case 'time':
        ...
        $('#lr_component_dataSource').lrselect({
            ...
            select: function (item) {
                ...
                if (dfop.dataSource == '0') {
                    ...
                    $('.lr_component_relation').hide();//by wxl 级联下拉框
                    $('.lr_component_relation_field').hide();//by wxl 级联下拉框
                }
                else {
                    $('.dataSourceId').show();
                    $('#lr_component_dataItemCode1').hide();
                    $('.lr_component_relation').show();//by wxl 级联下拉框
                }
            }
